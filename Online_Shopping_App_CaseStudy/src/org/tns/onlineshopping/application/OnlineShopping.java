...
import org.tns.onlineshopping.services.AdminService;
import org.tns.onlineshopping.services.CustomerService;
import org.tns.onlineshopping.services.OrderService;
import org.tns.onlineshopping.services.ProductService;
...
public class OnlineShopping {
	...
	private static void removeProduct(Scanner scanner) {
		...
		if(productService.removeProduct(productId)) {
			...
			System.out.println("Product Not Found or Not Exists");
		}
	...
	private static void viewAdmins() {
		...
		if(adminService.getAdmins().isEmpty()) {
			System.out.println("No Admins are there yet.(Empty)");
		}
		else {
	...
	private static void viewCustomers() {
		...
		if(customerService.getCustomers().isEmpty()) {
			System.out.println("No Cutomers are there yet.(Empty)");
		}
		else {
	...
	private static void viewOrders(Scanner scanner) {
		...
		if(customer.getOrders().isEmpty()) {
			System.out.println("Not Placed any orders yet.(Empty)");
		}
	...
	private static void viewProducts() {
		...
		if(productService.getProducts().isEmpty()) {
			System.out.println("No Products are there yet.(Empty)");
		}
